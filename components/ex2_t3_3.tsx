...
const imageMap = {
  'veste.jpg': require('@/assets/images/th3/veste.jpg'),
  'pantalon.jpg': require('@/assets/images/th3/pantalon.jpg'),
  'cravate.jpg': require('@/assets/images/th3/cravate.jpg'),
  'chaussure.jpg': require('@/assets/images/th3/chaussure.jpg'),
  'babouche.jpg': require('@/assets/images/th3/babouche.jpg'),
};
...
const rawData = [
  {
    ...
    images: ['veste.jpg', 'pantalon.jpg', 'cravate.jpg', 'chaussure.jpg']
  },
  {
    label: "👖 Les pantalons",
    correct: 'pantalon.jpg',
    audio: require('@/assets/sounds/ghomala/th3/pantalon.wav'),
    images: ['pantalon.jpg', 'babouche.jpg', 'chaussure.jpg', 'cravate.jpg']
  },
  {
    label: "La cravate",
    correct: 'cravate.jpg',
    audio: require('@/assets/sounds/ghomala/th3/cravate.wav'),
    images: ['chaussure.jpg', 'cravate.jpg', 'veste.jpg', 'babouche.jpg']
  },
  {
    label: "👞 La chaussure",
    correct: 'chaussure.jpg',
    audio: require('@/assets/sounds/ghomala/th3/chaussure.wav'),
    images: ['cravate.jpg', 'babouche.jpg', 'chaussure.jpg', 'veste.jpg']
  },
  {
    label: "🩴 Les paires de babouches",
    correct: 'babouche.jpg',
    audio: require('@/assets/sounds/ghomala/th3/babouche.wav'),
    images: ['pantalon.jpg', 'babouche.jpg', 'chaussure.jpg', 'veste.jpg']
  }
];
      ...
      if (index === data[current].correctIndex) {
        if (current + 1 < data.length) {
          ...
          if (!themeFinished.current) {
            ...
            setXp(score);
            await fetch(`${API_URL}/api/theme1/advance`, {
              method: "POST",
