...
const rawData = [
  { label: "🐝 Les abeilles", correct: 'abeilles.png', audio: require('@/assets/sounds/douala/th1/abeilles.wav'), images: ['abeilles.png', 'sauterelle.png', 'cafard.jpg', 'singe.jpg'] },
  { label: "🦗 La sauterelle", correct: 'sauterelle.png', audio: require('@/assets/sounds/douala/th1/sauterelle.wav'), images: ['sauterelle.png', 'lion.jpg', 'cafard.jpg', 'singe.jpg'] },
  { label: "🪳 Le cafard", correct: 'cafard.jpg', audio: require('@/assets/sounds/douala/th1/cafard.wav'), images: ['singe.jpg', 'cafard.jpg', 'abeilles.png', 'poisson.jpg'] },
  ...
  { label: "Le Lion", correct: 'lion.jpg', audio: require('@/assets/sounds/douala/th1/lion.wav'), images: ['singe.jpg', 'lion.jpg', 'cafard.jpg', 'abeilles.png'] },
  { label: "🐒 Les singes", correct: 'singe.jpg', audio: require('@/assets/sounds/douala/th1/singes.wav'), images: ['abeilles.png', 'sauterelle.png', 'cafard.jpg', 'singe.jpg'] }
];
    ...
    setTimeout(async () => {
      ...
      if (index === data[current].correctIndex) {
        if (current + 1 < data.length) {
          ...
          setXpEarned(score);
          setShowFinal(true);
          await fetch(`${API_URL}/api/theme0/advance`, {
            method: 'POST',
