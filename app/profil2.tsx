...
import ThemeComponent from "@/components/profile2";
...
export default function Ex1T0_2Page() {
  ...
  const renderTab = (label, iconName, route, isLogo = false, badge = null) => {
    const isActive = route === "/profil2"; // ✅ "Leçons" est maintenant l'onglet actif
    ...
    <>
      ...
      >
        <View style={styles.tabs}>
          ...
          {renderTab("Exercices", "trophy-outline", "/exercises", false, "bassa")}
